...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { Cliente: @compra.Cliente, Fecha Compra: @compra.Fecha Compra, Monto: @compra.Monto } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { Cliente: @compra.Cliente, Fecha Compra: @compra.Fecha Compra, Monto: @compra.Monto } }
